...
public class OrderTest {
	...
	public void testUrl() {
		try {
			...
			String phone = "18610009898";
			String product_id = "500"; // 500M
			String order_id = "20160727000012";
			long time = System.currentTimeMillis();
			String secret = "222222";
			String sign = MD5Util.EncodeString(String.format("phone=%s&product_id=%s&order_id=%s&time=%d&secret=%s", phone,
					product_id, order_id, time,secret));
