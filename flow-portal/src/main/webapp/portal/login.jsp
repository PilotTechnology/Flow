				...
				<form action="${ctx}/portal/system/login!login.action" id="login_form" method="post">
					...
					<div class="form-group">
						<label for="j_captcha" class="t">验证码：</label>
						 <input id="validatCode" name="validatCode" type="text" class="form-control x164 in">
						 <img id="validatImg" alt="点击更换" title="点击更换" src="/portal/image.jsp?r=Math.random()" class="m" 
  							 onclick="var randomnum=Math.random();document.getElementById('validatImg').src='/portal/image.jsp?r=' + randomnum;"
						 >
					</div>
					<div class="form-group">
						<label class="t"></label>
